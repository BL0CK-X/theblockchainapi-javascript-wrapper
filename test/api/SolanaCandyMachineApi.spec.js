...
(function(root, factory) {
  ...
  describe('SolanaCandyMachineApi', function() {
    describe('solanaNftCandyMachineConfigInfoPost', function() {
      it('should call solanaNftCandyMachineConfigInfoPost successfully', function(done) {
        //uncomment below and update the code to test solanaNftCandyMachineConfigInfoPost
        //instance.solanaNftCandyMachineConfigInfoPost(function(error) {
    ...
    describe('solanaNftCandyMachineInfoPost', function() {
      it('should call solanaNftCandyMachineInfoPost successfully', function(done) {
        //uncomment below and update the code to test solanaNftCandyMachineInfoPost
        //instance.solanaNftCandyMachineInfoPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('solanaNftCandyMachineMintPost', function() {
      it('should call solanaNftCandyMachineMintPost successfully', function(done) {
        //uncomment below and update the code to test solanaNftCandyMachineMintPost
        //instance.solanaNftCandyMachineMintPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('solanaNftCandyMachineNftsPost', function() {
      it('should call solanaNftCandyMachineNftsPost successfully', function(done) {
        //uncomment below and update the code to test solanaNftCandyMachineNftsPost
        //instance.solanaNftCandyMachineNftsPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('solanaNftCandyMachinePost', function() {
      it('should call solanaNftCandyMachinePost successfully', function(done) {
        //uncomment below and update the code to test solanaNftCandyMachinePost
        //instance.solanaNftCandyMachinePost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
