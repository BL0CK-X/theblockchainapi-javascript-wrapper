...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new theblockchainapi.EndpointApi();
  });
  ...
  describe('EndpointApi', function() {
    ...
    describe('setEndpoint', function() {
      it('should call setEndpoint successfully', function(done) {
        //uncomment below and update the code to test setEndpoint
        //instance.setEndpoint(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
