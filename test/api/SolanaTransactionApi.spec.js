...
(function(root, factory) {
  ...
  describe('SolanaTransactionApi', function() {
    describe('solanaTransactionNetworkTxSignatureGet', function() {
      it('should call solanaTransactionNetworkTxSignatureGet successfully', function(done) {
        //uncomment below and update the code to test solanaTransactionNetworkTxSignatureGet
        //instance.solanaTransactionNetworkTxSignatureGet(function(error) {
