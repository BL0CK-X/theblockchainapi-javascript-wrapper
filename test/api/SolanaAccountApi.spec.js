...
(function(root, factory) {
  ...
  describe('SolanaAccountApi', function() {
    describe('solanaAccountNetworkPublicKeyGet', function() {
      it('should call solanaAccountNetworkPublicKeyGet successfully', function(done) {
        //uncomment below and update the code to test solanaAccountNetworkPublicKeyGet
        //instance.solanaAccountNetworkPublicKeyGet(function(error) {
