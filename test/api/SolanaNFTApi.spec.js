...
(function(root, factory) {
  ...
  describe('SolanaNFTApi', function() {
    describe('solanaNftCandyMachineIdPost', function() {
      it('should call solanaNftCandyMachineIdPost successfully', function(done) {
        //uncomment below and update the code to test solanaNftCandyMachineIdPost
        //instance.solanaNftCandyMachineIdPost(function(error) {
    ...
    describe('solanaNftMintFeeGet', function() {
      it('should call solanaNftMintFeeGet successfully', function(done) {
        //uncomment below and update the code to test solanaNftMintFeeGet
        //instance.solanaNftMintFeeGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('solanaNftNetworkMintAddressGet', function() {
      it('should call solanaNftNetworkMintAddressGet successfully', function(done) {
        //uncomment below and update the code to test solanaNftNetworkMintAddressGet
        //instance.solanaNftNetworkMintAddressGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('solanaNftPost', function() {
      it('should call solanaNftPost successfully', function(done) {
        //uncomment below and update the code to test solanaNftPost
        //instance.solanaNftPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
