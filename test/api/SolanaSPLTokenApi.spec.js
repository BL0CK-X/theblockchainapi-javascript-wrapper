...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new theblockchainapi.SolanaSPLTokenApi();
  });
  ...
  describe('SolanaSPLTokenApi', function() {
    describe('solanaGetSPLToken', function() {
      it('should call solanaGetSPLToken successfully', function(done) {
        //uncomment below and update the code to test solanaGetSPLToken
        //instance.solanaGetSPLToken(function(error) {
