...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheBlockchainApi.UploadFileRequest();
  });
  ...
  describe('UploadFileRequest', function() {
    it('should create an instance of UploadFileRequest', function() {
      // uncomment below and update the code to test UploadFileRequest
      //var instance = new TheBlockchainApi.UploadFileRequest();
      //expect(instance).to.be.a(TheBlockchainApi.UploadFileRequest);
    });
