...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new theblockchainapi.GeneralSecretRecoveryPhrase();
  });
  ...
  describe('GeneralSecretRecoveryPhrase', function() {
    it('should create an instance of GeneralSecretRecoveryPhrase', function() {
      // uncomment below and update the code to test GeneralSecretRecoveryPhrase
      //var instance = new theblockchainapi.GeneralSecretRecoveryPhrase();
      //expect(instance).to.be.a(theblockchainapi.GeneralSecretRecoveryPhrase);
    });
