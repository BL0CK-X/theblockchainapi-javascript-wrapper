...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new theblockchainapi.GeneratePrivateKey();
  });
  ...
  describe('GeneratePrivateKey', function() {
    it('should create an instance of GeneratePrivateKey', function() {
      // uncomment below and update the code to test GeneratePrivateKey
      //var instance = new theblockchainapi.GeneratePrivateKey();
      //expect(instance).to.be.a(theblockchainapi.GeneratePrivateKey);
    });
