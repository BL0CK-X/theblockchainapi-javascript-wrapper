...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new theblockchainapi.NFTSearchResponse();
  });
  ...
  describe('NFTSearchResponse', function() {
    it('should create an instance of NFTSearchResponse', function() {
      // uncomment below and update the code to test NFTSearchResponse
      //var instance = new theblockchainapi.NFTSearchResponse();
      //expect(instance).to.be.a(theblockchainapi.NFTSearchResponse);
    });
