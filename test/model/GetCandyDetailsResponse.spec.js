...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheBlockchainApi.GetCandyDetailsResponse();
  });
  ...
  describe('GetCandyDetailsResponse', function() {
    it('should create an instance of GetCandyDetailsResponse', function() {
      // uncomment below and update the code to test GetCandyDetailsResponse
      //var instance = new TheBlockchainApi.GetCandyDetailsResponse();
      //expect(instance).to.be.a(TheBlockchainApi.GetCandyDetailsResponse);
    });
