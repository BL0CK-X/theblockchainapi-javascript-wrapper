...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new theblockchainapi.SolSeaListRequest();
  });
  ...
  describe('SolSeaListRequest', function() {
    it('should create an instance of SolSeaListRequest', function() {
      // uncomment below and update the code to test SolSeaListRequest
      //var instance = new theblockchainapi.SolSeaListRequest();
      //expect(instance).to.be.a(theblockchainapi.SolSeaListRequest);
    });
