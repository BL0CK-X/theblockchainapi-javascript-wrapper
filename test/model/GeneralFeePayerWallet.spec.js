...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new theblockchainapi.GeneralFeePayerWallet();
  });
  ...
  describe('GeneralFeePayerWallet', function() {
    it('should create an instance of GeneralFeePayerWallet', function() {
      // uncomment below and update the code to test GeneralFeePayerWallet
      //var instance = new theblockchainapi.GeneralFeePayerWallet();
      //expect(instance).to.be.a(theblockchainapi.GeneralFeePayerWallet);
    });
