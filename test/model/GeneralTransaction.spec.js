...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new theblockchainapi.GeneralTransaction();
  });
  ...
  describe('GeneralTransaction', function() {
    it('should create an instance of GeneralTransaction', function() {
      // uncomment below and update the code to test GeneralTransaction
      //var instance = new theblockchainapi.GeneralTransaction();
      //expect(instance).to.be.a(theblockchainapi.GeneralTransaction);
    });

    it('should have the property accessList (base name: "access_list")', function() {
