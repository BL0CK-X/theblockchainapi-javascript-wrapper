...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new theblockchainapi.PrivateKey();
  });
  ...
  describe('PrivateKey', function() {
    it('should create an instance of PrivateKey', function() {
      // uncomment below and update the code to test PrivateKey
      //var instance = new theblockchainapi.PrivateKey();
      //expect(instance).to.be.a(theblockchainapi.PrivateKey);
    });
