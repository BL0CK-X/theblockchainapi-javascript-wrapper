...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new theblockchainapi.NFTAnalyticsRequest();
  });
  ...
  describe('NFTAnalyticsRequest', function() {
    it('should create an instance of NFTAnalyticsRequest', function() {
      // uncomment below and update the code to test NFTAnalyticsRequest
      //var instance = new theblockchainapi.NFTAnalyticsRequest();
      //expect(instance).to.be.a(theblockchainapi.NFTAnalyticsRequest);
    });

    it('should have the property mintAddresses (base name: "mint_addresses")', function() {
      // uncomment below and update the code to test the property mintAddresses
      //var instance = new theblockchainapi.NFTAnalyticsRequest();
