...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheBlockchainApi.MintNFTErrorResponse();
  });
  ...
  describe('MintNFTErrorResponse', function() {
    it('should create an instance of MintNFTErrorResponse', function() {
      // uncomment below and update the code to test MintNFTErrorResponse
      //var instance = new TheBlockchainApi.MintNFTErrorResponse();
      //expect(instance).to.be.a(TheBlockchainApi.MintNFTErrorResponse);
    });
