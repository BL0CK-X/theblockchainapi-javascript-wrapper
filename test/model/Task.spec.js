...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheBlockchainApi.Task();
  });
  ...
  describe('Task', function() {
    it('should create an instance of Task', function() {
      ...
      //var instance = new TheBlockchainApi.Task();
      //expect(instance).to.be.a(TheBlockchainApi.Task);
    });
    ...
    it('should have the property timeCompleted (base name: "time_completed")', function() {
