...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new theblockchainapi.SolSeaDelistRequest();
  });
  ...
  describe('SolSeaDelistRequest', function() {
    it('should create an instance of SolSeaDelistRequest', function() {
      // uncomment below and update the code to test SolSeaDelistRequest
      //var instance = new theblockchainapi.SolSeaDelistRequest();
      //expect(instance).to.be.a(theblockchainapi.SolSeaDelistRequest);
    });
