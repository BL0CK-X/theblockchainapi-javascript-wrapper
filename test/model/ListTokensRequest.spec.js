...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new theblockchainapi.ListTokensRequest();
  });
  ...
  describe('ListTokensRequest', function() {
    it('should create an instance of ListTokensRequest', function() {
      // uncomment below and update the code to test ListTokensRequest
      //var instance = new theblockchainapi.ListTokensRequest();
      //expect(instance).to.be.a(theblockchainapi.ListTokensRequest);
    });

    it('should have the property includeNfts (base name: "include_nfts")', function() {
      // uncomment below and update the code to test the property includeNfts
      //var instance = new theblockchainapi.ListTokensRequest();
      //expect(instance).to.be();
    });

    it('should have the property includeZeroBalanceHoldings (base name: "include_zero_balance_holdings")', function() {
      // uncomment below and update the code to test the property includeZeroBalanceHoldings
      //var instance = new theblockchainapi.ListTokensRequest();
      //expect(instance).to.be();
    });
