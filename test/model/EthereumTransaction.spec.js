...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new theblockchainapi.EthereumTransaction();
  });
  ...
  describe('EthereumTransaction', function() {
    it('should create an instance of EthereumTransaction', function() {
      // uncomment below and update the code to test EthereumTransaction
      //var instance = new theblockchainapi.EthereumTransaction();
      //expect(instance).to.be.a(theblockchainapi.EthereumTransaction);
    });
