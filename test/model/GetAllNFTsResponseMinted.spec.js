...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new theblockchainapi.GetAllNFTsResponseMinted();
  });
  ...
  describe('GetAllNFTsResponseMinted', function() {
    it('should create an instance of GetAllNFTsResponseMinted', function() {
      // uncomment below and update the code to test GetAllNFTsResponseMinted
      //var instance = new theblockchainapi.GetAllNFTsResponseMinted();
      //expect(instance).to.be.a(theblockchainapi.GetAllNFTsResponseMinted);
    });
