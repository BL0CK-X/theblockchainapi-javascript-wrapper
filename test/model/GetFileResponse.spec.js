...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheBlockchainApi.GetFileResponse();
  });
  ...
  describe('GetFileResponse', function() {
    it('should create an instance of GetFileResponse', function() {
      // uncomment below and update the code to test GetFileResponse
      //var instance = new TheBlockchainApi.GetFileResponse();
      //expect(instance).to.be.a(TheBlockchainApi.GetFileResponse);
    });
