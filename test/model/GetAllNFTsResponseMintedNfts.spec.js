...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new theblockchainapi.GetAllNFTsResponseMintedNfts();
  });
  ...
  describe('GetAllNFTsResponseMintedNfts', function() {
    it('should create an instance of GetAllNFTsResponseMintedNfts', function() {
      // uncomment below and update the code to test GetAllNFTsResponseMintedNfts
      //var instance = new theblockchainapi.GetAllNFTsResponseMintedNfts();
      //expect(instance).to.be.a(theblockchainapi.GetAllNFTsResponseMintedNfts);
    });

    it('should have the property nftMetadata (base name: "nft_metadata")', function() {
      // uncomment below and update the code to test the property nftMetadata
      //var instance = new theblockchainapi.GetAllNFTsResponseMintedNfts();
      //expect(instance).to.be();
    });

    it('should have the property pubKeyHash (base name: "pub_key_hash")', function() {
      // uncomment below and update the code to test the property pubKeyHash
      //var instance = new theblockchainapi.GetAllNFTsResponseMintedNfts();
      //expect(instance).to.be();
    });
