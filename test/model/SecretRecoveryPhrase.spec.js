...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new theblockchainapi.SecretRecoveryPhrase();
  });
  ...
  describe('SecretRecoveryPhrase', function() {
    it('should create an instance of SecretRecoveryPhrase', function() {
      // uncomment below and update the code to test SecretRecoveryPhrase
      //var instance = new theblockchainapi.SecretRecoveryPhrase();
      //expect(instance).to.be.a(theblockchainapi.SecretRecoveryPhrase);
    });
