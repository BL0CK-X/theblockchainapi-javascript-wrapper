...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new theblockchainapi.GeneralWallet();
  });
  ...
  describe('GeneralWallet', function() {
    it('should create an instance of GeneralWallet', function() {
      // uncomment below and update the code to test GeneralWallet
      //var instance = new theblockchainapi.GeneralWallet();
      //expect(instance).to.be.a(theblockchainapi.GeneralWallet);
    });
