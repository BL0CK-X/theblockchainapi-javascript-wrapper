...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new theblockchainapi.CandyMachineSearchResponse();
  });
  ...
  describe('CandyMachineSearchResponse', function() {
    it('should create an instance of CandyMachineSearchResponse', function() {
      // uncomment below and update the code to test CandyMachineSearchResponse
      //var instance = new theblockchainapi.CandyMachineSearchResponse();
      //expect(instance).to.be.a(theblockchainapi.CandyMachineSearchResponse);
    });
