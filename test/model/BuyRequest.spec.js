...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new theblockchainapi.BuyRequest();
  });
  ...
  describe('BuyRequest', function() {
    it('should create an instance of BuyRequest', function() {
      // uncomment below and update the code to test BuyRequest
      //var instance = new theblockchainapi.BuyRequest();
      //expect(instance).to.be.a(theblockchainapi.BuyRequest);
    });
