...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new theblockchainapi.GetAllNFTsResponseUnminted();
  });
  ...
  describe('GetAllNFTsResponseUnminted', function() {
    it('should create an instance of GetAllNFTsResponseUnminted', function() {
      // uncomment below and update the code to test GetAllNFTsResponseUnminted
      //var instance = new theblockchainapi.GetAllNFTsResponseUnminted();
      //expect(instance).to.be.a(theblockchainapi.GetAllNFTsResponseUnminted);
    });
