...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new theblockchainapi.NFTTransaction();
  });
  ...
  describe('NFTTransaction', function() {
    it('should create an instance of NFTTransaction', function() {
      // uncomment below and update the code to test NFTTransaction
      //var instance = new theblockchainapi.NFTTransaction();
      //expect(instance).to.be.a(theblockchainapi.NFTTransaction);
    });
