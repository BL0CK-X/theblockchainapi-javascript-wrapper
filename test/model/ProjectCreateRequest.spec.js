...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new theblockchainapi.ProjectCreateRequest();
  });
  ...
  describe('ProjectCreateRequest', function() {
    it('should create an instance of ProjectCreateRequest', function() {
      // uncomment below and update the code to test ProjectCreateRequest
      //var instance = new theblockchainapi.ProjectCreateRequest();
      //expect(instance).to.be.a(theblockchainapi.ProjectCreateRequest);
    });
