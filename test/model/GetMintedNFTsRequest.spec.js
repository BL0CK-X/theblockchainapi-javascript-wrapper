...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheBlockchainApi.GetMintedNFTsRequest();
  });
  ...
  describe('GetMintedNFTsRequest', function() {
    it('should create an instance of GetMintedNFTsRequest', function() {
      // uncomment below and update the code to test GetMintedNFTsRequest
      //var instance = new TheBlockchainApi.GetMintedNFTsRequest();
      //expect(instance).to.be.a(TheBlockchainApi.GetMintedNFTsRequest);
    });
