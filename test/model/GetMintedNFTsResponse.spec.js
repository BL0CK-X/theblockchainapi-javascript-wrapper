...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheBlockchainApi.GetMintedNFTsResponse();
  });
  ...
  describe('GetMintedNFTsResponse', function() {
    it('should create an instance of GetMintedNFTsResponse', function() {
      // uncomment below and update the code to test GetMintedNFTsResponse
      //var instance = new TheBlockchainApi.GetMintedNFTsResponse();
      //expect(instance).to.be.a(TheBlockchainApi.GetMintedNFTsResponse);
    });
