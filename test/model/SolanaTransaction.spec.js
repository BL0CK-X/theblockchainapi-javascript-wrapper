...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new theblockchainapi.SolanaTransaction();
  });
  ...
  describe('SolanaTransaction', function() {
    it('should create an instance of SolanaTransaction', function() {
      // uncomment below and update the code to test SolanaTransaction
      //var instance = new theblockchainapi.SolanaTransaction();
      //expect(instance).to.be.a(theblockchainapi.SolanaTransaction);
    });
