...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new theblockchainapi.NFTAnalyticsResponse();
  });
  ...
  describe('NFTAnalyticsResponse', function() {
    it('should create an instance of NFTAnalyticsResponse', function() {
      // uncomment below and update the code to test NFTAnalyticsResponse
      //var instance = new theblockchainapi.NFTAnalyticsResponse();
      //expect(instance).to.be.a(theblockchainapi.NFTAnalyticsResponse);
    });
