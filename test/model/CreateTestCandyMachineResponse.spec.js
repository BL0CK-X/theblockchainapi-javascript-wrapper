...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheBlockchainApi.CreateTestCandyMachineResponse();
  });
  ...
  describe('CreateTestCandyMachineResponse', function() {
    it('should create an instance of CreateTestCandyMachineResponse', function() {
      // uncomment below and update the code to test CreateTestCandyMachineResponse
      //var instance = new TheBlockchainApi.CreateTestCandyMachineResponse();
      //expect(instance).to.be.a(TheBlockchainApi.CreateTestCandyMachineResponse);
    });
