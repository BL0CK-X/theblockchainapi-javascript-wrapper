...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new theblockchainapi.EthereumTransactionCompiledResponse();
  });
  ...
  describe('EthereumTransactionCompiledResponse', function() {
    it('should create an instance of EthereumTransactionCompiledResponse', function() {
      // uncomment below and update the code to test EthereumTransactionCompiledResponse
      //var instance = new theblockchainapi.EthereumTransactionCompiledResponse();
      //expect(instance).to.be.a(theblockchainapi.EthereumTransactionCompiledResponse);
    });
