...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheBlockchainApi.MintNFTRequest();
  });
  ...
  describe('MintNFTRequest', function() {
    it('should create an instance of MintNFTRequest', function() {
      // uncomment below and update the code to test MintNFTRequest
      //var instance = new TheBlockchainApi.MintNFTRequest();
      //expect(instance).to.be.a(TheBlockchainApi.MintNFTRequest);
    });
