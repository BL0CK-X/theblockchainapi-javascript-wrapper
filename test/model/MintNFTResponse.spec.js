...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheBlockchainApi.MintNFTResponse();
  });
  ...
  describe('MintNFTResponse', function() {
    it('should create an instance of MintNFTResponse', function() {
      // uncomment below and update the code to test MintNFTResponse
      //var instance = new TheBlockchainApi.MintNFTResponse();
      //expect(instance).to.be.a(TheBlockchainApi.MintNFTResponse);
    });
