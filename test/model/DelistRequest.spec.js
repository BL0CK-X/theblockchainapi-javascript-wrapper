...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new theblockchainapi.DelistRequest();
  });
  ...
  describe('DelistRequest', function() {
    it('should create an instance of DelistRequest', function() {
      // uncomment below and update the code to test DelistRequest
      //var instance = new theblockchainapi.DelistRequest();
      //expect(instance).to.be.a(theblockchainapi.DelistRequest);
    });
