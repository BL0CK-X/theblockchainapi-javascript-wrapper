...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new theblockchainapi.B58PrivateKey();
  });
  ...
  describe('B58PrivateKey', function() {
    it('should create an instance of B58PrivateKey', function() {
      // uncomment below and update the code to test B58PrivateKey
      //var instance = new theblockchainapi.B58PrivateKey();
      //expect(instance).to.be.a(theblockchainapi.B58PrivateKey);
    });
