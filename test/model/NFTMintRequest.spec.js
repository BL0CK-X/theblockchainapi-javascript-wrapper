...
(function(root, factory) {
  ...
  describe('NFTMintRequest', function() {
    ...
    it('should have the property nftSymbol (base name: "nft_symbol")', function() {
      // uncomment below and update the code to test the property nftSymbol
      //var instance = new TheBlockchainApi.NFTMintRequest();
      //expect(instance).to.be();
    });

    it('should have the property nftDescription (base name: "nft_description")', function() {
      // uncomment below and update the code to test the property nftDescription
      //var instance = new TheBlockchainApi.NFTMintRequest();
      //expect(instance).to.be();
    });

    it('should have the property nftUrl (base name: "nft_url")', function() {
      // uncomment below and update the code to test the property nftUrl
      //var instance = new TheBlockchainApi.NFTMintRequest();
      //expect(instance).to.be();
    });
    ...
    it('should have the property nftUploadMethod (base name: "nft_upload_method")', function() {
      // uncomment below and update the code to test the property nftUploadMethod
      //var instance = new TheBlockchainApi.NFTMintRequest();
      //expect(instance).to.be();
    });
