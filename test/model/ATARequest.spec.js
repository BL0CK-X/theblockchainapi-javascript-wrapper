...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheBlockchainApi.ATARequest();
  });
  ...
  describe('ATARequest', function() {
    it('should create an instance of ATARequest', function() {
      // uncomment below and update the code to test ATARequest
      //var instance = new TheBlockchainApi.ATARequest();
      //expect(instance).to.be.a(TheBlockchainApi.ATARequest);
    });
