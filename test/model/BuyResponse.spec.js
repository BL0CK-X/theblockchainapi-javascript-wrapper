...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new theblockchainapi.BuyResponse();
  });
  ...
  describe('BuyResponse', function() {
    it('should create an instance of BuyResponse', function() {
      // uncomment below and update the code to test BuyResponse
      //var instance = new theblockchainapi.BuyResponse();
      //expect(instance).to.be.a(theblockchainapi.BuyResponse);
    });
