...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheBlockchainApi.CreateTestCandyMachineRequest();
  });
  ...
  describe('CreateTestCandyMachineRequest', function() {
    it('should create an instance of CreateTestCandyMachineRequest', function() {
      // uncomment below and update the code to test CreateTestCandyMachineRequest
      //var instance = new TheBlockchainApi.CreateTestCandyMachineRequest();
      //expect(instance).to.be.a(TheBlockchainApi.CreateTestCandyMachineRequest);
    });
