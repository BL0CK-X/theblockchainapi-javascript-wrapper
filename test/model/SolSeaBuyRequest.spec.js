...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new theblockchainapi.SolSeaBuyRequest();
  });
  ...
  describe('SolSeaBuyRequest', function() {
    it('should create an instance of SolSeaBuyRequest', function() {
      // uncomment below and update the code to test SolSeaBuyRequest
      //var instance = new theblockchainapi.SolSeaBuyRequest();
      //expect(instance).to.be.a(theblockchainapi.SolSeaBuyRequest);
    });
    ...
    it('should have the property nftPrice (base name: "nft_price")', function() {
