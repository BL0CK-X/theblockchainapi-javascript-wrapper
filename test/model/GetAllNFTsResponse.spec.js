...
(function(root, factory) {
  ...
  describe('GetAllNFTsResponse', function() {
    ...
    it('should have the property minted (base name: "minted")', function() {
      // uncomment below and update the code to test the property minted
      //var instance = new theblockchainapi.GetAllNFTsResponse();
      //expect(instance).to.be();
    });

    it('should have the property unminted (base name: "unminted")', function() {
      // uncomment below and update the code to test the property unminted
      //var instance = new theblockchainapi.GetAllNFTsResponse();
      //expect(instance).to.be();
    });
