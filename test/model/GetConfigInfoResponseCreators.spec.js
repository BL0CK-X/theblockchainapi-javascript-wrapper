...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheBlockchainApi.GetConfigInfoResponseCreators();
  });
  ...
  describe('GetConfigInfoResponseCreators', function() {
    it('should create an instance of GetConfigInfoResponseCreators', function() {
      // uncomment below and update the code to test GetConfigInfoResponseCreators
      //var instance = new TheBlockchainApi.GetConfigInfoResponseCreators();
      //expect(instance).to.be.a(TheBlockchainApi.GetConfigInfoResponseCreators);
    });
