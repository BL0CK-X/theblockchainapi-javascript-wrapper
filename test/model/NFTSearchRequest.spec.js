...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new theblockchainapi.NFTSearchRequest();
  });
  ...
  describe('NFTSearchRequest', function() {
    it('should create an instance of NFTSearchRequest', function() {
      // uncomment below and update the code to test NFTSearchRequest
      //var instance = new theblockchainapi.NFTSearchRequest();
      //expect(instance).to.be.a(theblockchainapi.NFTSearchRequest);
    });
    ...
    it('should have the property mintAddress (base name: "mint_address")', function() {
      // uncomment below and update the code to test the property mintAddress
      //var instance = new theblockchainapi.NFTSearchRequest();
      //expect(instance).to.be();
    });

    it('should have the property mintAddressSearchMethod (base name: "mint_address_search_method")', function() {
      // uncomment below and update the code to test the property mintAddressSearchMethod
      //var instance = new theblockchainapi.NFTSearchRequest();
      //expect(instance).to.be();
    });
    ...
    it('should have the property nameSearchMethod (base name: "name_search_method")', function() {
      // uncomment below and update the code to test the property nameSearchMethod
      //var instance = new theblockchainapi.NFTSearchRequest();
      //expect(instance).to.be();
    });
    ...
    it('should have the property uriSearchMethod (base name: "uri_search_method")', function() {
      // uncomment below and update the code to test the property uriSearchMethod
      //var instance = new theblockchainapi.NFTSearchRequest();
      //expect(instance).to.be();
    });
