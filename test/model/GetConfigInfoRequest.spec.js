...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheBlockchainApi.GetConfigInfoRequest();
  });
  ...
  describe('GetConfigInfoRequest', function() {
    it('should create an instance of GetConfigInfoRequest', function() {
      // uncomment below and update the code to test GetConfigInfoRequest
      //var instance = new TheBlockchainApi.GetConfigInfoRequest();
      //expect(instance).to.be.a(TheBlockchainApi.GetConfigInfoRequest);
    });
