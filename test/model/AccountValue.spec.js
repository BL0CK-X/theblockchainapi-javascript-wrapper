...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new theblockchainapi.AccountValue();
  });
  ...
  describe('AccountValue', function() {
    it('should create an instance of AccountValue', function() {
      // uncomment below and update the code to test AccountValue
      //var instance = new theblockchainapi.AccountValue();
      //expect(instance).to.be.a(theblockchainapi.AccountValue);
    });
    ...
    it('should have the property rentEpoch (base name: "rent_epoch")', function() {
      // uncomment below and update the code to test the property rentEpoch
      //var instance = new theblockchainapi.AccountValue();
      //expect(instance).to.be();
    });
