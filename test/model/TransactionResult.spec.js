...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new theblockchainapi.TransactionResult();
  });
  ...
  describe('TransactionResult', function() {
    it('should create an instance of TransactionResult', function() {
      ...
      //var instance = new theblockchainapi.TransactionResult();
      //expect(instance).to.be.a(theblockchainapi.TransactionResult);
    });
