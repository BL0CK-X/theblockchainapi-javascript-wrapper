...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheBlockchainApi.GetConfigInfoResponse();
  });
  ...
  describe('GetConfigInfoResponse', function() {
    it('should create an instance of GetConfigInfoResponse', function() {
      // uncomment below and update the code to test GetConfigInfoResponse
      //var instance = new TheBlockchainApi.GetConfigInfoResponse();
      //expect(instance).to.be.a(TheBlockchainApi.GetConfigInfoResponse);
    });
