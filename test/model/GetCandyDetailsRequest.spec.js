...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheBlockchainApi.GetCandyDetailsRequest();
  });
  ...
  describe('GetCandyDetailsRequest', function() {
    it('should create an instance of GetCandyDetailsRequest', function() {
      // uncomment below and update the code to test GetCandyDetailsRequest
      //var instance = new TheBlockchainApi.GetCandyDetailsRequest();
      //expect(instance).to.be.a(TheBlockchainApi.GetCandyDetailsRequest);
    });
