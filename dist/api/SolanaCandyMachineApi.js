...
var SolanaCandyMachineApi = /*#__PURE__*/function () {
  ...
  */
  ...
  _createClass(SolanaCandyMachineApi, [{
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link Array.<module:model/CandyMachineSearchResponse>} and HTTP response
     */
    ...
    value: function solanaSearchCandyMachinesWithHttpInfo(opts) {
      ...
      var contentTypes = ['application/json'];
      var accepts = ['application/json'];
      var returnType = [_CandyMachineSearchResponse["default"]];
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/CandyMachineSearchRequest} opts.candyMachineSearchRequest 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link Array.<module:model/CandyMachineSearchResponse>}
     */
