...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.theblockchainapi.com/v1') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
        ...
        this.authentications = {
            'APIKeyID': {type: 'apiKey', 'in': 'header', name: 'APIKeyID'},
            'APISecretKey': {type: 'apiKey', 'in': 'header', name: 'APISecretKey'}
        }
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/null/Javascript'
        };
