...
export default class SolanaWalletApi {
    ...
    */
     ...
     */
    solanaGetWalletTransactionsWithHttpInfo(network, publicKey) {
      let postBody = null;
      // verify the required parameter 'network' is set
      if (network === undefined || network === null) {
      ...
      return this.apiClient.callApi(
        '/solana/wallet/{network}/{public_key}/transactions', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
     ...
     */
    solanaGetWalletTransactions(network, publicKey) {
      return this.solanaGetWalletTransactionsWithHttpInfo(network, publicKey)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    solanaTransferWithHttpInfo(opts) {
      ...
      let contentTypes = ['application/json'];
      let accepts = ['application/json'];
      let returnType = DoubleTransferResponse;
      return this.apiClient.callApi(
