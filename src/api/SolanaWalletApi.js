...
export default class SolanaWalletApi {
    ...
    */
    ...
    solanaGenerateSecretRecoveryPhraseWithHttpInfo() {
      ...
      return this.apiClient.callApi(
        '/solana/wallet/secret_recovery_phrase', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
     ...
     */
    solanaGetTokensBelongingToWalletWithHttpInfo(network, publicKey) {
      let postBody = null;
      // verify the required parameter 'network' is set
      if (network === undefined || network === null) {
     ...
     */
    solanaGetTokensBelongingToWallet(network, publicKey) {
      return this.solanaGetTokensBelongingToWalletWithHttpInfo(network, publicKey)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
