...
export default class SolanaAccountApi {
    ...
    */
     ...
     */
    solanaGetAccountWithHttpInfo(network, publicKey) {
      let postBody = null;
      ...
      return this.apiClient.callApi(
        '/solana/account/{network}/{public_key}', 'GET',
     ...
     */
    solanaGetAccount(network, publicKey) {
      return this.solanaGetAccountWithHttpInfo(network, publicKey)
     ...
     */
    solanaGetAccountIsCandyMachineWithHttpInfo(network, publicKey) {
      let postBody = null;
      // verify the required parameter 'network' is set
      if (network === undefined || network === null) {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = AccountIsCandyMachine;
      return this.apiClient.callApi(
        '/solana/account/{network}/{public_key}/is_candy_machine', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
     ...
     */
    solanaGetAccountIsCandyMachine(network, publicKey) {
      return this.solanaGetAccountIsCandyMachineWithHttpInfo(network, publicKey)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     */
    solanaGetAccountIsNFTWithHttpInfo(network, publicKey) {
      let postBody = null;
      // verify the required parameter 'network' is set
      if (network === undefined || network === null) {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = AccountIsNFT;
      return this.apiClient.callApi(
        '/solana/account/{network}/{public_key}/is_nft', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
     ...
     */
    solanaGetAccountIsNFT(network, publicKey) {
      return this.solanaGetAccountIsNFTWithHttpInfo(network, publicKey)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
