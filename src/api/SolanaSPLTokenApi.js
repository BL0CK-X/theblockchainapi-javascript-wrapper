...
* @version 1.0.9
*/
export default class SolanaSPLTokenApi {
    ...
    */
     ...
     */
    solanaGetSPLTokenWithHttpInfo(publicKey, network) {
      let postBody = null;
      ...
      let returnType = GetSPLTokenResponse;
      return this.apiClient.callApi(
        '/solana/spl-token/{network}/{public_key}', 'GET',
     ...
     */
    solanaGetSPLToken(publicKey, network) {
      return this.solanaGetSPLTokenWithHttpInfo(publicKey, network)
