...
export default class SolanaTransactionApi {
    ...
    */
     ...
     */
    solanaGetTransactionWithHttpInfo(network, txSignature) {
      let postBody = null;
      ...
      return this.apiClient.callApi(
        '/solana/transaction/{network}/{tx_signature}', 'GET',
     ...
     */
    solanaGetTransaction(network, txSignature) {
      return this.solanaGetTransactionWithHttpInfo(network, txSignature)
