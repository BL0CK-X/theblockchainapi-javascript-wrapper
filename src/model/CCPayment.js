    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('blockchain_payment_details')) {
                obj['blockchain_payment_details'] = CCPaymentBlockchainPaymentDetails.constructFromObject(data['blockchain_payment_details']);
            }
            if (data.hasOwnProperty('customer_id')) {
                obj['customer_id'] = ApiClient.convertToType(data['customer_id'], 'String');
            }
            if (data.hasOwnProperty('payment_validation_code')) {
                obj['payment_validation_code'] = ApiClient.convertToType(data['payment_validation_code'], 'String');
            }
