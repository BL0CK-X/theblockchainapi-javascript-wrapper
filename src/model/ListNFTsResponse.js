    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('nfts_owned')) {
                obj['nfts_owned'] = ApiClient.convertToType(data['nfts_owned'], ['String']);
            }
            if (data.hasOwnProperty('nfts_metadata')) {
                obj['nfts_metadata'] = ApiClient.convertToType(data['nfts_metadata'], [NFT]);
            }
        }
        return obj;
    }
...
export default ListNFTsResponse;
