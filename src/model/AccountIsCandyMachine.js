...
class AccountIsCandyMachine {
     ...
     */
    static initialize(obj, isCandyMachine) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('is_candy_machine')) {
                obj['is_candy_machine'] = ApiClient.convertToType(data['is_candy_machine'], 'Boolean');
            }
...
export default AccountIsCandyMachine;
