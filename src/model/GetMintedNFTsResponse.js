    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('nft_metadata')) {
                obj['nft_metadata'] = NFT.constructFromObject(data['nft_metadata']);
            }
            if (data.hasOwnProperty('pub_key_hash')) {
                obj['pub_key_hash'] = ApiClient.convertToType(data['pub_key_hash'], 'String');
            }
        }
        return obj;
    }
...
export default GetMintedNFTsResponse;
