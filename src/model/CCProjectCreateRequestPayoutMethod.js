 ...
 * @version 1.0.9407
 */
class CCProjectCreateRequestPayoutMethod {
    /**
     ...
     */
    constructor(blockchainIdentifier) { 
     ...
     */
    static initialize(obj, blockchainIdentifier) { 
...
export default CCProjectCreateRequestPayoutMethod;
