    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('freeze_authority')) {
                obj['freeze_authority'] = ApiClient.convertToType(data['freeze_authority'], 'String');
            }
            if (data.hasOwnProperty('mint_authority')) {
                obj['mint_authority'] = ApiClient.convertToType(data['mint_authority'], 'String');
            }
            if (data.hasOwnProperty('is_initialized')) {
                obj['is_initialized'] = ApiClient.convertToType(data['is_initialized'], 'Boolean');
            }
...
export default GetSPLTokenResponse;
