...
class WalletIdentifiers {
     ...
     */
    constructor() { 
        AvalancheCChainPublicAddress.initialize(this);AvalancheXPChainPublicAddress.initialize(this);BSCPublicAddress.initialize(this);EthereumPublicAddress.initialize(this);NearPublicKey.initialize(this);SolanaPublicKey.initialize(this);
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            AvalancheCChainPublicAddress.constructFromObject(data, obj);
            AvalancheXPChainPublicAddress.constructFromObject(data, obj);
            BSCPublicAddress.constructFromObject(data, obj);
            EthereumPublicAddress.constructFromObject(data, obj);
            NearPublicKey.constructFromObject(data, obj);
            SolanaPublicKey.constructFromObject(data, obj);

            if (data.hasOwnProperty('hex_public_address')) {
                obj['hex_public_address'] = ApiClient.convertToType(data['hex_public_address'], 'String');
            }
            if (data.hasOwnProperty('hex_public_key')) {
                obj['hex_public_key'] = ApiClient.convertToType(data['hex_public_key'], 'String');
            }
            if (data.hasOwnProperty('bech_public_address')) {
                obj['bech_public_address'] = ApiClient.convertToType(data['bech_public_address'], 'String');
            }
 ...
 */
WalletIdentifiers.prototype['public_key'] = undefined;


// Implement AvalancheCChainPublicAddress interface:
/**
 * The public address in hex form of the wallet. This is commonly used in Ethereum, Binance, and Avalanche C-Chain. (e.g., `0xB2b2d42C3adA171633E36b427F062f85A642F453`) 
 * @member {String} hex_public_address
 */
...
// Implement AvalancheXPChainPublicAddress interface:
/**
 * The bech-32 encoded public address of the wallet, commonly used for the X and P chains of Avalanche. (e.g., `X-avax1rlxm7ygahlzfjgj4s965t0lk0ucm8v48rc9r5r`) 
 * @member {String} bech_public_address
 */
...
// Implement BSCPublicAddress interface:
/**
 * The public address in hex form of the wallet. This is commonly used in Ethereum, Binance, and Avalanche C-Chain. (e.g., `0xB2b2d42C3adA171633E36b427F062f85A642F453`) 
 * @member {String} hex_public_address
 */
...
// Implement EthereumPublicAddress interface:
/**
 * The public address in hex form of the wallet. This is commonly used in Ethereum, Binance, and Avalanche C-Chain. (e.g., `0xB2b2d42C3adA171633E36b427F062f85A642F453`) 
 * @member {String} hex_public_address
 */
...
// Implement NearPublicKey interface:
/**
 * The public key in hex form. This is used in the Near blockchain. (e.g., `0xdf96e3094ab33558dbe14e743aceded3779307b931e12bd6f526fe450db70910`) 
 * @member {String} hex_public_key
 */
...
// Implement SolanaPublicKey interface:
/**
 * The public key in base58 form. This is used in the Solana blockchain. (e.g., `3Gdu3Uf97jw4Kac8xHEm5Hqmob3BrvJhf3We8s9t5Q2c`) 
 * @member {String} public_key
 */
...
export default WalletIdentifiers;
