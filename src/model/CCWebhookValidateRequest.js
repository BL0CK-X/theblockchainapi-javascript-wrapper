 ...
 * @version 1.0.9407
 */
class CCWebhookValidateRequest {
    /**
     ...
     */
    constructor(webhookId, webhookSignature, timeSent) { 
     ...
     */
    static initialize(obj, webhookId, webhookSignature, timeSent) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('webhook_signature')) {
                obj['webhook_signature'] = ApiClient.convertToType(data['webhook_signature'], Object);
            }
            if (data.hasOwnProperty('time_sent')) {
                obj['time_sent'] = ApiClient.convertToType(data['time_sent'], 'Number');
            }
        }
        return obj;
    }
...
export default CCWebhookValidateRequest;
