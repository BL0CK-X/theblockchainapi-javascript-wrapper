    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('exchange_readable')) {
                obj['exchange_readable'] = ApiClient.convertToType(data['exchange_readable'], 'String');
            }
            if (data.hasOwnProperty('listing_transaction_signature')) {
                obj['listing_transaction_signature'] = ApiClient.convertToType(data['listing_transaction_signature'], 'String');
            }
...
export default GetNFTListingResponse;
