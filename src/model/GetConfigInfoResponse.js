    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('creators')) {
                obj['creators'] = ApiClient.convertToType(data['creators'], [GetConfigInfoResponseCreators]);
            }
            ...
            if (data.hasOwnProperty('retain_authority')) {
                obj['retain_authority'] = ApiClient.convertToType(data['retain_authority'], 'String');
            }
...
export default GetConfigInfoResponse;
