 ...
 * @version 1.0.9407
 */
class NFTOwnerAdvancedResponseContract {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('contract_blockchain_identifier')) {
                obj['contract_blockchain_identifier'] = ApiClient.convertToType(data['contract_blockchain_identifier'], 'String');
            }
...
export default NFTOwnerAdvancedResponseContract;
