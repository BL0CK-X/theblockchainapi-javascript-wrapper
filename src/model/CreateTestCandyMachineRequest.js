...
class CreateTestCandyMachineRequest {
     ...
     */
    constructor(secretRecoveryPhrase) { 
     ...
     */
    static initialize(obj, secretRecoveryPhrase) { 
    ...
    static constructFromObject(data, obj) {
        ...
        if (data) {
            ...
            if (data.hasOwnProperty('include_gatekeeper')) {
                obj['include_gatekeeper'] = ApiClient.convertToType(data['include_gatekeeper'], 'Boolean');
            }
        }
        return obj;
    }
...
export default CreateTestCandyMachineRequest;
