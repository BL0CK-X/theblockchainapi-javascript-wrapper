    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('include_nfts')) {
                obj['include_nfts'] = ApiClient.convertToType(data['include_nfts'], 'Boolean');
            }
            if (data.hasOwnProperty('include_zero_balance_holdings')) {
                obj['include_zero_balance_holdings'] = ApiClient.convertToType(data['include_zero_balance_holdings'], 'Boolean');
            }
        }
        return obj;
    }
