...
class NFTAnalyticsRequest {
     ...
     */
    static initialize(obj, mintAddresses) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('mint_addresses')) {
                obj['mint_addresses'] = ApiClient.convertToType(data['mint_addresses'], ['String']);
            }
...
export default NFTAnalyticsRequest;
