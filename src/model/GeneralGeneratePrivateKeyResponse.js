 ...
 * @version 1.0.9407
 */
class GeneralGeneratePrivateKeyResponse {
    /**
     ...
     */
    constructor(hexPrivateKey, privateKey, b58PrivateKey) { 
        HexPrivateKey.initialize(this, hexPrivateKey);GeneralPrivateKey.initialize(this, privateKey);GeneralB58PrivateKey.initialize(this, b58PrivateKey);
     ...
     */
    static initialize(obj, hexPrivateKey, privateKey, b58PrivateKey) { 
 ...
 */
GeneralGeneratePrivateKeyResponse.prototype['b58_private_key'] = undefined;
...
export default GeneralGeneratePrivateKeyResponse;
