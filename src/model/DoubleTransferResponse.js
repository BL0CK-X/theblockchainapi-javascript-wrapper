...
class DoubleTransferResponse {
     ...
     */
    constructor() { 
        TransferResponse.initialize(this);TransferResponseCompiled.initialize(this);
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            TransferResponse.constructFromObject(data, obj);
            TransferResponseCompiled.constructFromObject(data, obj);
 ...
 */
DoubleTransferResponse.prototype['compiled_transaction'] = undefined;


// Implement TransferResponse interface:
/**
 * The signature of the transaction
 * @member {String} transaction_signature
 */
...
// Implement TransferResponseCompiled interface:
/**
 * A base58 encoded byte array in string representation. Really easy to submit to Phantom. See <a href=\"https://github.com/BL0CK-X/blockchain-api/blob/main/examples/tutorials/phantom_tutorials/transfer_solana.html\" target=\"_blank\">here</a> for an example on how to submit it to a Phantom wallet for signing.
 * @member {String} b58_compiled_transaction
 */
...
export default DoubleTransferResponse;
