    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('minted_nfts')) {
                obj['minted_nfts'] = ApiClient.convertToType(data['minted_nfts'], [GetAllNFTsResponseMintedNfts]);
            }
            if (data.hasOwnProperty('unminted_nfts')) {
                obj['unminted_nfts'] = ApiClient.convertToType(data['unminted_nfts'], [GetAllNFTsResponseUnmintedNfts]);
            }
...
export default GetAllNFTsResponse;
