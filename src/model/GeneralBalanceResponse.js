...
class GeneralBalanceResponse {
     ...
     */
    static initialize(obj, balance, network) { 
        obj['balance'] = balance;
        obj['network'] = network;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('integer_balance')) {
                obj['integer_balance'] = ApiClient.convertToType(data['integer_balance'], 'Number');
            }
...
export default GeneralBalanceResponse;
