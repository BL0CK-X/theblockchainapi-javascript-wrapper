...
class ATAResponse {
     ...
     */
    constructor(associatedTokenAddress) { 
     ...
     */
    static initialize(obj, associatedTokenAddress) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('associated_token_address')) {
                obj['associated_token_address'] = ApiClient.convertToType(data['associated_token_address'], 'String');
            }
        }
        return obj;
    }
