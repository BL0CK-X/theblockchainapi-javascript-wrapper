    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('start_time')) {
                obj['start_time'] = ApiClient.convertToType(data['start_time'], Object);
            }
            if (data.hasOwnProperty('end_time')) {
                obj['end_time'] = ApiClient.convertToType(data['end_time'], Object);
            }
            if (data.hasOwnProperty('transaction_history')) {
                obj['transaction_history'] = NFTAnalyticsResponseTransactionHistory.constructFromObject(data['transaction_history']);
            }
...
export default NFTAnalyticsResponse;
